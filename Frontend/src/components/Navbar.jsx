      ...
      <li>
        <a
          onClick={() => {
            if (!authUser) {
              navigate("/");
              toast.error("Please login to access course");
            } else {
              navigate("/course");
            }
          }}
      ...
      >
        <div className="navbar ">
          <div className="navbar-start">
            ...
            <a className=" font-bold text-3xl cursor-pointer ">Book Store</a>
          </div>
            ...
            {authUser ? (
              ...
              <>
                <label htmlFor="my_modal_6" className="">
                  <a
                    className=" bg-black text-white text-center px-4 py-2 rounded-lg cursor-pointer
